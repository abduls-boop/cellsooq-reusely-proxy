...
// Usage: /api/public/catalog/models?brand=apple&device=iphone
...
export default withCors(async function handler(req, res) {
  ...
  if (!brand || !device) {
    return res.status(400).json({ error: 'Missing brand and/or device query. Example: ?brand=apple&device=iphone' });
  }
